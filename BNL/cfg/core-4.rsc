...
/interface vrrp
add comment=vlan5 interface=vlan5 name=vrrp1 preemption-mode=yes priority=100
/ip address
add address=10.4.0.7/24 interface=vlan4
add address=127.1.2.2/30 interface=vlan5
...
/routing ospf
instance add name=ospf-instance-1 out-filter-chain=ospf router-id=0.0.1.4
