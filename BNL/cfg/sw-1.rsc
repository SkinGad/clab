...
/ip address
add address=10.4.0.8/24 interface=vlan4
add address=10.10.10.2/30 interface=vlan10
...
/routing ospf
instance add name=ospf-instance-1 out-filter-chain=ospf router-id=0.0.2.1
