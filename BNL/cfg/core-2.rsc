...
add bridge=bridge1 interface=ether4 pvid=5
...
/interface vrrp
add comment=vlan5 interface=vlan5 name=vrrp1 preemption-mode=yes priority=110
/ip address
add address=10.4.0.5/24 interface=vlan4
add address=127.1.2.1/30 interface=vlan5
add address=10.5.0.254/24 interface=vrrp1
...
/routing ospf
instance add name=ospf-instance-1 out-filter-chain=ospf router-id=0.0.1.2
