...
/ip address
add address=10.4.0.9/24 interface=vlan4
add address=10.10.20.2/30 interface=vlan20
add address=10.10.21.2/30 interface=vlan20
...
/routing ospf
instance add name=ospf-instance-1 out-filter-chain=ospf router-id=0.0.2.2
