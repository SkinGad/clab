/ip address
add address=1.1.5.1/30 interface=ether2
add address=1.1.1.1/30 interface=ether3
add address=1.2.1.1/30 interface=ether4

add address=1.10.1.2/30 interface=ether5

/routing ospf
instance add name=ospf-instance-1 out-filter-chain=ostf router-id=0.0.0.1
